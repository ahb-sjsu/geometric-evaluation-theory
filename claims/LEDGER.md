...
| GET-5 | Metric identified up to scale and ideal up to the metric's kernel from the order on an open set | `[proved]` | paper Thm 4 | G1, G5 | `GET.Uniqueness.ideal_unique`, `GET.Uniqueness.scale_free` (one-dimensional case); the general case not yet checked |
