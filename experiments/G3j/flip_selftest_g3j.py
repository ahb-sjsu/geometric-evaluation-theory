...
ladder with THIS gap and pair count and nothing else changes.
    ...
    python flip_selftest_g3j.py flip_config_qwen7b.json selftest_qwen7b [a1=0.2,c_decay=0.25]
...
are exercised at the same scale. The values used are recorded in PREREG-G3J.md Section 6.
"""
